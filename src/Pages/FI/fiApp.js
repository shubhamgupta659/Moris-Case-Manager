...
const FIApp = () => {
    ...
    const [formData, setFormData] = useState({
        applicationId: state ? state.applicationId : params.id,
        ...
        appType: state ? state.appType : null,
    ...
    return (
        <div className="app-main-container">
            <div className="app-header-container"><h4>{params.action === 'add' ? 'ADD Application' : 'EDIT Application'}</h4></div>
            <div className="form-container">
                <Form ref={formRef}>
                    ...
                    <Form.Item
                        ...
                        name={`appType`} // Use a unique name for each Form.Item componenty
                        rules={[
                            { required: true, message: 'Please select application Type' },
                        ]}
                        initialValue={formData.appType}
                    ><Select
                            defaultValue=""
                            onChange={handleChange}
